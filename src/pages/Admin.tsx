          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                ...
                Wallet Settings
                <HelpTooltip content="Configure payout wallet and commission settings" />
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <div>
                <Label htmlFor="payout-wallet" className="flex items-center gap-2">
                  ...
                  <HelpTooltip content="EVM wallet address where fees and commissions will be sent" />
                </Label>
                <Input
                  id="payout-wallet"
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                ...
                Escrow Product Settings
                <HelpTooltip content="Configure what you're selling and default payment settings" />
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <div>
