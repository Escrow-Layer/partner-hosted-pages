...
const mockEscrowData: Record<string, EscrowData> = {
  'esc_12345': {
    ...
    partnerId: 'flippa',
    customFields: [
      { id: 'domain', label: 'Domain', value: 'crypto.flippa.com', type: 'text', required: true },
      { id: 'registrar', label: 'Registrar', value: 'GoDaddy', type: 'text' },
      { id: 'transfer_code', label: 'Transfer Code', value: 'TRF123456', type: 'text', required: true },
    ],
    milestones: [
      {
        id: 'init',
        title: 'Escrow Initiated',
        description: 'Escrow created and waiting for deposit',
        status: 'completed',
      ...
      },
      {
        ...
        description: 'Cryptocurrency deposit confirmed',
        status: 'pending',
      },
      {
        id: 'verification',
        title: 'Asset Verification',
        description: 'Verifying domain ownership and transfer readiness',
        status: 'pending',
      },
      {
        id: 'release',
        title: 'Funds Released',
        description: 'Transaction completed and funds released',
        status: 'pending',
      },
    ],
    partnerBranding: {
    ...
    redirectUrl: 'https://flippa.com/deals/crypto-domain',
  },
};
